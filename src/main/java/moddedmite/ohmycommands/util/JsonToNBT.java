package moddedmite.ohmycommands.util;
...
public class JsonToNBT {
    public static NBTBase getTagFromJson(String jsonString) throws NBTException {
        jsonString = jsonString.trim();
        int i = func_150310_b(jsonString);
        ...
        if (i != 1) {
            ...
            if (jsonString.startsWith("{")) {
                any = func_150316_a("tag", jsonString);
            } else {
                any = func_150316_a(func_150313_b(jsonString, false), func_150311_c(jsonString, false));
            }
            ...
            if (!p_150316_1_.endsWith("]")) {
                ...
                while (p_150316_1_.length() > 0) {
                    ...
                    if (s2.length() > 0) {
                        ...
                        FishModLoader.LOGGER.debug(p_150316_1_);
                    }
                }
    ...
    static class Compound extends JsonToNBT.Any {
        protected ArrayList<Any> field_150491_b = new ArrayList();
    ...
    static class List extends JsonToNBT.Any {
        protected ArrayList<JsonToNBT.Any> field_150492_b = new ArrayList();
        ...
        public NBTBase func_150489_a() {
            try {
                if (this.field_150493_b.matches("[-+]?[0-9]*\\.?[0-9]+[d|D]")) {
                    return new NBTTagDouble(this.field_150493_b.substring(0, this.field_150493_b.length() - 1));
                } else if (this.field_150493_b.matches("[-+]?[0-9]*\\.?[0-9]+[f|F]")) {
                    return new NBTTagFloat(this.field_150493_b.substring(0, this.field_150493_b.length() - 1));
                } else if (this.field_150493_b.matches("[-+]?[0-9]+[b|B]")) {
                    return new NBTTagByte(this.field_150493_b.substring(0, this.field_150493_b.length() - 1));
                } else if (this.field_150493_b.matches("[-+]?[0-9]+[l|L]")) {
                    return new NBTTagLong(this.field_150493_b.substring(0, this.field_150493_b.length() - 1));
                } else if (this.field_150493_b.matches("[-+]?[0-9]+[s|S]")) {
                    return new NBTTagShort(this.field_150493_b.substring(0, this.field_150493_b.length() - 1));
                } else if (this.field_150493_b.matches("[-+]?[0-9]+")) {
                    return new NBTTagInt(this.field_150493_b.substring(0, this.field_150493_b.length()));
                } else if (this.field_150493_b.matches("[-+]?[0-9]*\\.?[0-9]+")) {
                    return new NBTTagDouble(this.field_150493_b.substring(0, this.field_150493_b.length()));
                    ...
                    if (this.field_150493_b.startsWith("[") && this.field_150493_b.endsWith("]")) {
                        if (this.field_150493_b.length() > 2) {
                            ...
                            try {
                                if (astring.length <= 1) {
                                    return new NBTTagIntArray(s.trim());
                                } else {
...
//                                    }
                    ...
                    return new NBTTagByte(this.field_150493_b);
                }
