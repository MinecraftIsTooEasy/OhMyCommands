package moddedmite.ohmycommands.command.building;

import moddedmite.ohmycommands.api.BlockPos;
import moddedmite.ohmycommands.util.NameIDTranslator;
import net.minecraft.*;

import java.util.List;

import static moddedmite.ohmycommands.util.MiscUtil.getTabCompletionCoordinate;
import static moddedmite.ohmycommands.util.NameIDTranslator.getBlockIDByText;
